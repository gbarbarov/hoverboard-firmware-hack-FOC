...
#define INACTIVITY_TIMEOUT        60       // Minutes of not driving until poweroff. it is not very precise.
...
//GB anulo salida de debug por puerto serie 3
